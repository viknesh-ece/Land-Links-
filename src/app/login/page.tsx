    ...
    <div className="min-h-screen bg-black text-slate-100 flex flex-col font-sans">
      ...
      <main className="flex-grow flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-black">
          ...
          <div className="w-full max-w-md bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 sm:p-10 shadow-2xl relative z-10">
            ...
            {/* Error Message */}
            {error && (
              <div className="mb-6 flex items-start gap-2.5 p-4 rounded-2xl bg-rose-950/30 border border-rose-900/50 text-rose-400 text-xs font-bold shadow-md">
            ...
            <div className="space-y-5">
              ...
              <button
                onClick={handleLogin}
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-indigo-900/15 hover:shadow-indigo-900/25 active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none cursor-pointer border-0"
              >
                {loading ? (
