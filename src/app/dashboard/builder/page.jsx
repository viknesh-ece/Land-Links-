...
import { Building, MapPin, TrendingUp, ShieldCheck, Layers, ArrowUpRight, Compass } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {loading ? (<div className="space-y-3">
              ...
              </div>) : matchingLands.length === 0 ? (<div className="text-center py-12 bg-[#090d16]/50 rounded-3xl border border-slate-800/80 p-6 shadow-2xl">
                <p className="text-sm font-semibold text-slate-400 font-sans">No matching plots found in registry.</p>
              </div>) : (<div className="space-y-4">
                {matchingLands.map((prop) => (<div key={prop.id} className="bg-[#090d16]/75 border border-slate-800 rounded-3xl p-5 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:shadow-2xl transition-all duration-300">
