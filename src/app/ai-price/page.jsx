      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 animate-fade-in">
            <div className="bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-5">
              ...
              <div>
                ...
                <input type="number" step="0.01" placeholder="Enter Acres (e.g. 3.25)" value={acres} className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-semibold text-white placeholder:text-slate-600" onChange={(e) => setAcres(e.target.value)}/>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select value={region} onChange={(e) => setRegion(e.target.value)} className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-bold text-slate-200 cursor-pointer appearance-none">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select value={zoning} onChange={(e) => setZoning(e.target.value)} className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-bold text-slate-200 cursor-pointer appearance-none">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select value={roadWidth} onChange={(e) => setRoadWidth(e.target.value)} className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-bold text-slate-200 cursor-pointer appearance-none">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between text-xs font-bold text-slate-350 cursor-pointer p-3 border border-slate-800 rounded-xl hover:bg-slate-900 bg-slate-950/40">
                    ...
                    <input type="checkbox" checked={hasWater} onChange={(e) => setHasWater(e.target.checked)} className="rounded text-indigo-500 border-slate-700 bg-slate-950 h-4.5 w-4.5 cursor-pointer focus:ring-indigo-500"/>
                  </label>
                  <label className="flex items-center justify-between text-xs font-bold text-slate-350 cursor-pointer p-3 border border-slate-800 rounded-xl hover:bg-slate-900 bg-slate-950/40">
                    <span className="flex items-center gap-2">
                    ...
                    <input type="checkbox" checked={hasPower} onChange={(e) => setHasPower(e.target.checked)} className="rounded text-indigo-500 border-slate-700 bg-slate-950 h-4.5 w-4.5 cursor-pointer focus:ring-indigo-500"/>
                  </label>
                </div>
              </div>

              <button onClick={calculateValuation} disabled={loading || !acres} className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-800 disabled:text-slate-550 text-white rounded-2xl font-bold text-sm shadow-md disabled:shadow-none active:scale-[0.98] transition-all cursor-pointer flex items-center justify-center gap-2 border-0">
            ...
            <div className="bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-5">
              ...
              <div>
                ...
                <select value={initZone} onChange={(e) => setInitZone(e.target.value)} className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-bold text-slate-205 cursor-pointer appearance-none">
                  <option value="Agricultural" className="bg-slate-950 text-white">Agricultural Land</option>
                  <option value="Residential" className="bg-slate-950 text-white">Residential Development</option>
                  <option value="Industrial" className="bg-slate-950 text-white">Industrial Warehousing</option>
                  <option value="Commercial" className="bg-slate-950 text-white">Commercial / IT Park</option>
              ...
              <div>
                ...
                <select value={targetZone} onChange={(e) => setTargetZone(e.target.value)} className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-bold text-slate-205 cursor-pointer appearance-none">
                  <option value="Residential" className="bg-slate-950 text-white">Residential Development</option>
                  <option value="Commercial" className="bg-slate-950 text-white">Commercial / IT Park</option>
                  <option value="Industrial" className="bg-slate-950 text-white">Industrial Warehousing</option>
                  <option value="Agricultural" className="bg-slate-950 text-white">Agricultural Land</option>
              ...
              <div>
                ...
                <input type="number" step="0.01" placeholder="Enter Acres (e.g. 1.5)" value={zoneAcres} className="w-full px-4 py-3 rounded-xl bg-slate-955 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-semibold text-white placeholder:text-slate-600" onChange={(e) => setZoneAcres(e.target.value)}/>
              </div>

              <button onClick={calculateZoningFeasibility} disabled={zoningLoading || !zoneAcres} className="w-full py-3.5 bg-indigo-650 hover:bg-indigo-600 disabled:bg-slate-800 disabled:text-slate-550 text-white rounded-2xl font-bold text-xs shadow-md transition-all cursor-pointer flex items-center justify-center gap-2 border-0">
                {zoningLoading ? (<div className="h-4 w-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>) : (<>
                    <Activity className="h-4 w-4 text-indigo-300"/> Calculate Feasibility
                  </>)}
              </button>

              {/* Zoning Calculation Results */}
              {zoningResult && (<div className="mt-4 pt-4 border-t border-slate-850 space-y-4 animate-fade-in">
                  
                  {/* Score & Fees */}
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-slate-955 border border-slate-900 rounded-xl p-3.5 text-center">
                      <p className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Feasibility Score</p>
                      <p className={`text-2xl font-black mt-1 ${zoningResult.score >= 70 ? "text-emerald-450" : zoningResult.score >= 50 ? "text-amber-455" : "text-rose-455"}`}>{zoningResult.score}%</p>
                    </div>
                    <div className="bg-slate-955 border border-slate-900 rounded-xl p-3.5 text-center">
                      <p className="text-[9px] font-bold text-slate-505 uppercase tracking-wider">Est. Conversion Fee</p>
                      <p className="text-lg font-black text-indigo-400 mt-1 truncate">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-[9px] font-bold text-slate-505 uppercase tracking-widest">Compliance Status</h4>
                    <div className="grid grid-cols-2 gap-2 text-[10px] font-semibold text-slate-400">
                      <div className="flex items-center gap-1.5">
                        <span className={`h-1.5 w-1.5 rounded-full ${zoningResult.compliance.roadWidth ? "bg-emerald-450" : "bg-rose-455"}`}/>
                        <span>Road Width Check</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className={`h-1.5 w-1.5 rounded-full ${zoningResult.compliance.eia ? "bg-emerald-450" : "bg-rose-455"}`}/>
                        <span>EIA Compliance NOC</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className={`h-1.5 w-1.5 rounded-full ${zoningResult.compliance.masterPlan ? "bg-emerald-450" : "bg-rose-455"}`}/>
                        <span>Master Plan alignment</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className={`h-1.5 w-1.5 rounded-full ${zoningResult.compliance.fireSafety ? "bg-emerald-450" : "bg-rose-455"}`}/>
                  ...
                  <div className="border-t border-slate-900 pt-3.5 space-y-2">
                    <h4 className="text-[9px] font-bold text-slate-505 uppercase tracking-widest">NOC Approval Timeline</h4>
                    <div className="space-y-1.5 text-[10px] font-semibold text-slate-400">
                      <div className="flex justify-between items-center bg-slate-955/50 px-2.5 py-1.5 rounded border border-slate-900/60">
                        <span className="text-slate-500">CLU Form Submission</span>
                      ...
                      <div className="flex justify-between items-center bg-slate-955/50 px-2.5 py-1.5 rounded border border-slate-900/60">
                        <span className="text-slate-500">Town Planning NOC</span>
                        <span className="text-slate-300">~45 Days</span>
                      </div>
                      <div className="flex justify-between items-center bg-slate-955/50 px-2.5 py-1.5 rounded border border-slate-900/60">
                        <span className="text-slate-500">Gazetted Notification</span>
          ...
          <div className="lg:col-span-7">
            {valuation ? (<div className="bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 animate-in fade-in duration-200">
                ...
                <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row gap-3">
                  <button onClick={generatePDFReport} disabled={reportLoading} className="flex-grow py-3.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 text-white rounded-xl text-xs font-bold transition-all shadow cursor-pointer flex items-center justify-center gap-2">
              ...
              </div>) : (<div className="bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-3xl p-10 shadow-2xl text-center flex flex-col justify-center items-center h-full min-h-[400px]">
