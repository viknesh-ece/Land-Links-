  ...
  return (
    <div className="min-h-screen bg-black text-slate-100 flex flex-col">
      ...
      <main className="flex-grow flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16 relative bg-black">
          <div className="absolute inset-0 bg-glow-cyan opacity-20 pointer-events-none"></div>

          <div className="w-full max-w-md bg-[#090d16]/75 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm font-semibold text-slate-400 mt-1">
                Already registered?{" "}
                <Link href="/login" className="text-indigo-405 hover:text-indigo-300 transition-colors">
                  Sign in here
                </Link>
              </p>
            </div>
            ...
            {/* Error Message */}
            {error && (
              <div className="mb-6 flex items-start gap-2.5 p-3.5 rounded-xl bg-rose-955/30 border border-rose-900/50 text-rose-400 text-xs font-bold shadow-md">
            ...
            {/* Success Message */}
            {success && (
              <div className="mb-6 flex items-start gap-2.5 p-3.5 rounded-xl bg-emerald-955/30 border border-emerald-900/50 text-emerald-450 text-xs font-bold shadow-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-950 border border-slate-850 focus:outline-none focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 text-sm font-semibold text-white placeholder:text-slate-600 transition-all"
                    onChange={(e) =>
              ...
              <div className="pt-2">
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-indigo-900/15 hover:shadow-indigo-900/25 active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none border-0 cursor-pointer"
                >
                  {loading ? (
